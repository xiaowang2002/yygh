package com.atwzs.yygh.user.api;
...
import com.atwzs.yygh.user.service.UserInfoService;
import com.atwzs.yygh.user.utils.ConstantWXPropertiesUtil;
...
public class WeixinApiController {
    ...
    public String callback(String code, String state) {
        ...
        String result = null;
        try {
            result = com.atguigu.yygh.user.utils.HttpClientUtils.get(accessTokenUrl);
        } catch (Exception e) {
...
//        先根据openid进行数据库查询
        ...
        if (null == userInfo) {
            ...
            try {
                resultUserInfo = com.atguigu.yygh.user.utils.HttpClientUtils.get(userInfoUrl);
            } catch (Exception e) {

...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    @Resource   //和ScheduleRepository一样，只是换种方法实现
...
//创建匹配器，即如何使用查询条件
    ...
    public Map<String, Object> getBookingScheduleRule(Integer page, Integer limit, String hoscode, String depcode) {
        ...
        //科室
        Department department =departmentServie.getDepartment(hoscode, depcode);
        //大科室名称
...
//停号时间
    ...
    public ScheduleOrderVo getScheduleOrderVo(String scheduleId) {
        ...
        scheduleOrderVo.setDepname(departmentServie.getDepName(schedule.getHoscode(), schedule.getDepcode()));
...
//日期分页，由于预约周期不一样，页面一排最多显示7天数据，多了就要分页显示
    ...
    private Schedule packageSchedule(Schedule schedule) {
        ...
        //设置科室名称
        schedule.getParam().put("depname",departmentServie.getDepName(schedule.getHoscode(),schedule.getDepcode()));
        //设置日期对应星期
